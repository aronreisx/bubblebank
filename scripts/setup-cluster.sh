...
helm dependency update ~/Projects/bubblebank/infra/helm/nginx-ingress
helm install nginx-ingress ~/Projects/bubblebank/infra/helm/nginx-ingress --create-namespace --namespace ingress-nginx
